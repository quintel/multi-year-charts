    ...
    return (
      <div>
        <Router basename={`/${this.props.scenarioIDs.join(',')}`}>
          ...
          <div>
            <Route path="/" exact render={() => <Redirect to={`/charts/${charts[0].slug}`} />} />
            <Route
            ...
            <Route
              ...
              exact
              render={(props) => (
                <ChartContainer activeChart={props.match.params.slug} charts={charts} />
              )}
            />
...
export default connect(null, { setScenarios })(Main);
