...
const optionClasses = {
  ...
  unchecked: 'px-2 py-1 rounded cursor-pointer text-myetm-450 hover:bg-gray-700 hover:text-white transition',
};
...
function UnitToggle({ currentChart }: { currentChart: string }) {
  ...
  return (
    <RadioGroup
      ...
      className={`flex select-none items-center gap-1 rounded bg-myetm-200 p-1 text-sm font-medium ${
